...
/*********************************************************************************************************/
		...
		if( predictROD>0.095 || predictROD<-0.095 || predictPrice>predictVO.getMaxPrice90ZhiXin() )
			return predict( predictVO, closes, dates, ZPrice );
	...
	private PredictVO predict( PredictVO predictVO, List<Double> closes, List<LocalDate> dates, double ZPrice ){
		// TODO Auto-generated method stub
