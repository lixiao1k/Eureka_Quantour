...
public class Driver extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        time.set(2014, 3, 29);
        ssi1 = new SingleStockInfoVO().initObject("深发展A", (Calendar) time.clone(), "1", 11.02, 11.16, 11.25, 10.92, 10, 11.16, "SZ");
        ssi6 = new SingleStockInfoVO().initObject("中成股份", (Calendar) time.clone(), "151", 7.29, 7.38, 7.4, 7.29, 927600, 7.38, "SZ");


        time.set(2014, 03, 28);
        ssi2 = new SingleStockInfoVO().initObject("深发展A", (Calendar) time.clone(), "1", 11.25, 11.03, 11.28, 10.96, 12, 11.03, "SZ");
        ssi7 = new SingleStockInfoVO().initObject("中成股份", (Calendar) time.clone(), "151",7.53, 7.29, 7.53, 7.23, 1581700, 7.29, "SZ");

        time.set(2014, 03, 25);
        ssi3 = new SingleStockInfoVO().initObject("深发展A", (Calendar) time.clone(), "1", 11.23, 11.25, 11.52, 11.11, 13, 11.25, "SZ");
        ssi8 = new SingleStockInfoVO().initObject("中成股份", (Calendar) time.clone(), "151", 7.55, 7.47, 7.62, 7.45, 1153400, 7.47, "SZ");

        time.set(2014, 03, 24);
        ssi4 = new SingleStockInfoVO().initObject("深发展A", (Calendar) time.clone(), "1", 11.42, 11.23, 11.45, 11.12, 14, 11.23, "SZ");
        ssi9 = new SingleStockInfoVO().initObject("中成股份", (Calendar) time.clone(), "151", 7.74, 7.54, 7.74, 7.52, 1402300, 7.54, "SZ");

        time.set(2014, 03, 23);
        ssi5 = new SingleStockInfoVO().initObject("深发展A", (Calendar) time.clone(), "1", 11.08, 11.3, 11.45, 11.08, 8, 11.3, "SZ");
        ssi10 = new SingleStockInfoVO().initObject("中成股份", (Calendar) time.clone(), "151", 7.71, 7.74, 7.77, 7.63, 1074200, 7.74, "SZ");
        List<SingleStockInfoVO> a=new LinkedList<>();
        a.add(ssi1);
        a.add(ssi2);
        a.add(ssi3);
        a.add(ssi4);
        ...
        chartService s=new VolumeChart(a);
    ...
    ss9 = new EMAInfoVO((Calendar) time.clone(),3);

        time.set(2014, 03, 23);
    ss5 = new EMAInfoVO((Calendar) time.clone(),6);
